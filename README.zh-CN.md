...
1. 打开项目仓库：<https://github.com/JosephJagger/applefleets>
2. 点击绿色 **Code** 按钮。
...
AppleFleets 使用 [MIT License](LICENSE) 开源。第三方组件继续使用各自的许可证，详情见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。
