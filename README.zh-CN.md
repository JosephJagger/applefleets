...
<p align="center">Apple Watch 记录，iPhone 读取，Linux 上的 Codex 编辑，结果回到手机生成小红书图文和抖音竖屏视频。</p>
...
- iPhone 负责读取健康数据、预览、生成图片和视频、打开分享菜单。
...
3. 打开 AppleFleets。
4. App 读取到新跑步后会自动向 Linux Codex 提交任务。
5. 如果没有自动开始，点击“刷新”，再点击“用 Linux Codex 生成文案”。
6. 文案返回后，在手机上修改、生成并分享。
